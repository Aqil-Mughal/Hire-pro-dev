...
const Index = () => {
  ...
  const candidates = useQuery(CANDIDATES_WITHOUT_JOB_LINK, {
    variables: {
      skip: 0,
      take: 100000
    },
    onCompleted: (data) => {
      setData(data.AllCandidatesWithoutJobLink.map(item => {
        return {
          ...item,
    ...
    <div className="page-wrapper dashboard">
      ...
      <section className="user-dashboard">
        <div className="dashboard-outer">
          <BreadCrumb title="Job Seekers" desc="Guiding Job Seekers Toward Success" image="../images/custom/job-seeker-applications.png" />
