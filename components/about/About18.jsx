    ...
    <>
      ...
      <div className="content-column col-lg-6 col-md-12 col-sm-12 order-2"style={{textAlign:"left",width:"100%"}}>
        <div className="inner-column" data-aos="fade-left">
          <div className="sec-title">
            ...
            At [ company name ], we prioritize providing temporary workers with a thorough orientation session. This session serves to acquaint them with the organization's policies, procedures, and essential safety guidelines. 
            </div>
          </div>
      ...
      <div className="image-column col-lg-6 col-md-12 col-sm-12" style={{width:"100%"}}>
        <figure className="image-box" data-aos="fade-right">
          <img src="images/resource/Training1.png" alt="resource"style={{width:"60%"}} />
          <div className="corner-image" style={{ position: "absolute", top: "-50px",left: "57%",width: "100px", height: "150px" }}>
            <img src="images/resource/" alt="corner-image" style={{width:"100px",height:"100px"}} />
          </div>
        </figure>
