            ...
            <div className="content-column mb-0 col-xl-4 col-lg-6 col-md-12 col-sm-12" style={{  width: "50%" }}>
              <div className="wow fadeInLeft"  >
                <div className="sec-title mb-0">
                  ...
                  <div className="text mt-36 md:mt-16" style={{ fontSize: "20px", fontWeight: "400", color: "#959595", display: "flex", textAlign: "center" }} >
                ...
                <div style={{display:"flex",justifyContent:"center"}}>
                <a href="#" className="theme-btn -blue-outline mt-56 md:mt-16" style={{ backgroundColor: "#1967D2", color: "white" ,display:"flex",width:"50%",justifyContent:"center"}}>
                  Check Our Services
                </a>
                </div>
              </div>
