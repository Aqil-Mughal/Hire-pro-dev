      ...
      <div className="content-column col-lg-6 col-md-12 col-sm-12 order-2"style={{textAlign:"left",width:"100%"}}>
        <div className="inner-column" data-aos="fade-left">
          <div className="sec-title">
            ...
            [ company name ] goes beyond initial training and offers ongoing support to our temporary workers. 
            This includes valuable coaching and constructive feedback, enabling workers to further develop their
            skills and gain confidence in their temporary roles. Our commitment to providing continuous support 
            ensures that our workers feel supported and empowered throughout their assignments. 
            </div>
          </div>
